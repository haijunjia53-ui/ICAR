...
class ParamsControl(object):
    def __init__(self, opts, model):
        ...
        params_backbone = list(self.model.encoder.parameters())

        # 2. Alignment (New Attention Module) -> 归入 'new' 组或者单独一组
        # 这里我们将 Alignment 和 New Layers (Heads) 放在一起，给予较高的学习率
        params_new = list(self.model.new.parameters()) + list(self.model.alignment.parameters())
